...
import { useSelector, useDispatch } from "react-redux" //useSelector - used to select sth from the state ie. isError
...
const Register = () => {
    ...
    useEffect(() => {
        ...
        if (isSuccess || user){ //user - if they're already logged in
            navigate("/")
        }
        dispatch(reset())
